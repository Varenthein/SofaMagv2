let pages = [
  ...
  <div class="text">
    ...
    <div class="index">
      ...
      <a href="javascript:scrollToPage(5)">Był idolem, został bandziorem</a>
      <a href="javascript:scrollToPage(6)">FC Petrzalka Academia – Od Ligi Mistrzów do V ligi słowackiej</a>
      <a href="javascript:scrollToPage(7)">Ratunek dla sportu</a>
      <a href="javascript:scrollToPage(8)">Pan świata o którym nikt już nie chce pamiętać</a>
      <a href="javascript:scrollToPage(9)">Stracone nadzieje drużyny z Dagestanu</a>
      <a href="javascript:scrollToPage(10)">Sensacje w skokach, czyli zwyczajni jednostrzałowcy</a>
      <a href="javascript:scrollToPage(11)">Lukas Podolski — utracony talent</a>
...
{ "page": "3", "title": "FC Petrzalka Academia – Od Ligi Mistrzów do V ligi słowackiej", "content": new page("FC Petrzalka Academia – Od Ligi Mistrzów do V ligi słowackiej ","Tomasz Hatta","Piłka Nożna","Petrzalka.jpg", ["#Football", "#Słowacja"], "",
`Był rok 2005. Po pięknym meczu finałowym w Stambule, kolejna edycja Ligi Mistrzów przyniosła wielką niespodziankę w postaci klubu ze Słowacji, który w eliminacjach potrafił odprawić wicemistrza Szkocji oraz mistrza Serbii. Na piłkarskie salony zawitał zatem żądny dalszych przygód maleńki klub naszych południowych sąsiadów.
`,
`
...
<p>Kolejny mistrz Słowacji miał za zadanie zostawić po sobie dobre wrażenie w eliminacjach Ligi Mistrzów, bo i nie sądzę, że było wiele osób poza sztabem i zawodnikami Artmedii, którzy głęboko wierzyli w odniesienie sukcesu. Los w I rundzie eliminacji przypisał im kazachski Kairat Ałmaty. Pierwszy mecz między tymi zespołami na wyjeździe przyniósł przytłaczającą porażkę 0:2. Zrodził też wielkie obawy kibiców przed rewanżem, czy aby ta pierwsza w historii przygoda z walką o Ligę Mistrzów nie skończy się zbyt szybko. </p>

<p>Nadszedł dzień rewanżu. 20 lipca, stadion „NTC Senec” w pobliskim mieście Senec. Tego wieczoru zawodnicy słowackiej ekipy z wielką motywacją starali się pisać swoją historię. Do przerwy odrobili połowę strat z pierwszego meczu, a krótko po drugiej połowy  trafili do siatki po raz kolejny. W ten sposób zapewnili sobie trochę spokoju. Regulaminowy czas zmiany wyniku już nie przyniósł i potrzebna była dogrywka. Dosyć szybko pojawiły się kolejne schody, gdyż Kairat rozpoczął od strzelenia bardzo ważnej wyjazdowej bramki na 1:2. Po chwili Artmedia otrzymała rzut karny, który skutecznie wykorzystała, . Lecz potrzebna była jeszcze jedna bramka do awansu, a czasu w dogrywce było coraz mniej. Walka do końca jednak bardzo się opłaciła, W doliczonym już czasie dogrywki, gdy nawet bramkarz przez większość akcji był na połowie rywala, jedno z dośrodkowań znalazło się w polu karnym dobrze nam znanego Pavola Stano. To właśnie jego strzał dał tę czwartą, dającą awans bramkę! Artmedia rzutem na taśmę awansowała dalej! </p>
...
<p>Na rewanż Celtic wyszedł już w 200% naładowany, wierząc w swoje umiejętności i w to, że mogą odrobić tę olbrzymią stratę. W bramce już stanął Artur Boruc, a cały zespół nie pozwalał na zbyt wiele Słowakom. Do przerwy jednak udało się strzelić tylko dwie bramki. Bez błysku w ataku grał Maciej Żurawski, który został w drugiej połowie zmieniony przy wyniku 3:0. Jego zmiennik Craig Beattie zdołał pod koniec jeszcze dołożyć czwartą bramkę dając nadzieje na końcówkę meczu. Artmedia jednak już nie dała strzelić sobie bramki na 5:0 i piękny czas w eliminacjach Ligi Mistrzów trwał dalej! </p>

<p>Po takich bataliach w ostatniej fazie drużynę czekał dwumecz z Partizanem Belgrad i były to mecze bez większych emocji, a w obu padły wyniki 0:0, Zatem to, kto zagra w fazie grupowej musiały wyłonić rzuty karne. „Jedenastki” lepiej wykonywali zawodnicy Vladimira Weissa i to właśnie oni, jako drugi w historii klub Słowacki po MFK Koszyce, wywalczyli awans do Ligi Mistrzów! </p>

<h3>Mieli być chłopcami do bicia, wyszło nieco inaczej</h3>
<p>W fazie grupowej Artmedia trafiła do bardzo mocnej grupy z Interem Mediolan, FC Porto i Glasgow Rangers. Ta faza rządzi się już swoimi prawami, były więc obawy czy uda się z którymś z zespołów zapunktować. Zaczęło się od minimalnej porażki u siebie z Interem 0:1, by później w Portugalii zrobić ponownie coś wartego zapamiętania. Gdy w 39 minucie Porto wyszło na dwubramkowe prowadzenie, na pewno nie sądzili, że coś złego się im w ten wieczór wydarzy. Przed przerwą padła jednak kontaktowa bramka, a w drugiej połowie Artmedia wyciągnęła wynik na 3:2, osiągając historyczne i jedyne zwycięstwo w grupie. W kolejnych spotkaniach zespół Weissa dołożył  trzy remisy (dwa razy z Glasgow Rangers i raz z Porto), pozwalając się pokonać tylko Interowi (4:0). Bilans na zakończenie grupy to 6 punktów, 5 zdobytych bramek przy 9 straconych i trzecie miejsce w grupie premiowane awansem do fazy pucharowej Pucharu UEFA. Kapitalna przygoda małego klubu naszych południowych sąsiadów. </p>

<p>Wiosną, w 1/16 Pucharu UEFA, dwumecz z Levskim Sofia przyniósł porażkę 0:3. W taki sposób skończyły się puchary dla Artmedii. Kto by się spodziewał, że dopiero wiosną? Nie oszukujmy się...- nikt, nawet osoby związane z klubem. </p>

<h3>Ugruntowana pozycja w lidze</h3>
...
Na sezon 2007/08 po rocznej przerwie do klubu wrócił Vladimir Weiss i jego umiejętności trenerskie poprowadziły Artmedię do drugiego w historii mistrzostwa. Pomogło też ustabilizowanie formy czołowego już Juraja Halenara, który zdobył w rozgrywkach 16 bramek. W eliminacjach Ligi Mistrzów po wyeliminowaniu maltańskiej Valetty i fińskiego Tampere United, w trzeciej rundzie lepszy okazał się Juventus „degradując” Słowaków do ostatniej fazy eliminacji Pucharu UEFA, gdzie los przypisał Bragę, której niestety nie udało się pokonać. </p>

<p>Były to ostatnie miłe chwile w dotychczasowej historii klubu… </p>

<h3> „Pikowanie” w dół</h3>
<p>Po mistrzowskim sezonie Weiss objął reprezentację Słowacji, lecz największym problemem okazało się odejście z klubu inwestora - Ivana Kmotrika, który postanowił wykupić akcje sąsiedniego klubu Slovana Bratysława, by tam budować potęgę ligową. Gdy dopływ finansowy w Artmedii zaczął się kończyć, odchodzili też i czołowi piłkarze z powodu nie otrzymywania pensji. Stadion został zamknięty, a klub w sezonie 2008/09 zajął 6 miejsce w lidze, by już w kolejnym dołować w tabeli i zaliczyć spadek do 2. Ligi. Przez dwa lata gry poziom niżej, sytuacja była coraz gorsza, czego efektem okazał się spadek do 3. Ligi w 2012 roku. </p>
...
<p>Tak oto w 2014 roku nazwa klubu została zmieniona na FC Petrzalka Akademia i zarząd zgłosił klub na sezon 2014/15 do rozgrywek V ligi, by w ten sposób krok po kroku na dobrych wynikach móc się odbudować. Obecnie grają tam już drugi sezon i są liderem, co może budzić nadzieję na to, że za kilka lat coś dobrego wyniknie z tej odbudowy i oby tak właśnie było </p>

<p>Stary stadion, na którym niegdyś dawna Artmedia rozgrywała swoje mecze, został zrównany z ziemią i w to miejsce zostały postawione hotele. Cała sytuacja klubu pokazuje, że gdy ktoś potrafi dobrze zainwestować pieniądze, to może wszystko fajnie funkcjonować i jest realny sukces. Gdy jednak  środków zabraknie, nie ma jak tego utrzymać i z reguły kończy się to upadkiem. Jednak historia w pamięci tych starszych kibiców zostanie, a przeżycia z Ligi Mistrzów po prostu zapomnieć się nie da. Nie powinni żałować  wszystkich wydarzeń, a jedynie tego, że inwestor nagle postanowił zmienić otoczenie. </p>

`).get()},

{ "page": "3", "title": "Ratunek dla sportu", "content": new page("Ratunek dla sportu","Bartłomiej Iwański","Sport","lance.jpg", ["#Kolarstwo"], "Hase CC-BY_SA 3.0",
...
<h3>Wynalezienie sponsoringu</h3>
...
<figure class="img">
 <img src="source/--4/img/panswiata4.jpg" alt="">
 <figcaption>Wprowadzenie do futbolu sponsoringu spowodowało stopniową komercjalizację dyscypliny<span>Na zdjęciu materiał prasowy firmy Kia</span></figcaption>
</figure>
...
<h3>Jak dać pieniądzom wpłynąć do kieszeni</h3>
...
<figure class="img">
 <img src="source/--4/img/panswiata.jpg" alt="">
 <figcaption>Joao Havelange wraz ze swoim następcą - Seppem Blatterem<span>NL-HaNA, ANEFO CC-BY_SA 3.0</span></figcaption>
</figure>
<p>Za namową namaszczonego przez siebie następcy, Seppa Blattera, zrezygnował z tytułu honorowego prezydenta FIFA. Później wycofał się z członkostwa w MKOl, podając za powód przyczyny zdrowotne. Tak naprawdę uciekał, zanim zostałby wyrzucony. </p>
<p>Sam musiał usunąć się w cień, a była to dla niego kara najokrutniejsza z możliwych. Zawsze chętnie otaczał się pochlebcami (niektórzy posunęli się tak daleko, że w 1998 roku dostał nawet nominację do pokojowej Nagrody Nobla. Nagle opuścili go wszyscy. </p>
...
{ "page": "3", "title": "Stracone nadzieje drużyny z Dagestanu", "content": new page("Stracone nadzieje drużyny z Dagestanu","Piotr Porębski","Sport","anzy.jpg", ["#Football","#Rosja"], "Соккер CC-BY_SA 3.0",
`Ostatnie miesiące udowadniają, jak ogromną siłę ma pieniądz. Ogromne sumy wydawane przez chińskie kluby wydają się irracjonalne i bezsensowne, jednak mało kto pamięta, że kilka lat temu podobne możliwości
miał pewien klub z Rosji. Anży Machaczkała miało stać się światową potęgą, jednak po osiągnięciu kilku mniejszej wagi sukcesów, całkowicie spuścił z tonu i osiadł na futbolowej
mieliźnie. Co było tego powodem?
`,
`<p>Zespół z Machaczkały przez dłuższy okres swojego istnienia balansował na granicy pierwszej i drugiej ligi rosyjskiej, a okres jego największych sukcesów przypadał na początek dwudziestego pierwszego wieku. Wówczas drużyna z Dagestanu osiągnęła bardzo wysokie, czwarte miejsce w lidze, a także dotarła do finału krajowego pucharu. Po pewnym czasie Anży opuściło najwyższą klasę rozgrywkową i nie potrafiło do niej awansować przez blisko 7 lat. W 2009 roku dla klubu ponownie otworzyły się bramy raju, jednak tym razem przygoda w Premier Lidze miała być dłuższa i zdecydowanie obfitsza w sukcesy. Pomóc miała w tym jedna osoba, która pojawiła się w Machaczkale niczym rycerz na białym koniu. Jak się jednak później okazało, wniosła do klubu jedynie chwilowe szczęście. Sulejman Kerimow posiadający nie tylko imię jak słynny turecki sułtan, ale także ogromną ilość gotówki (świadczyło o tym miejsce w rankingu Forbesa), przejął akcje w klubie na początku 2011 roku i zapowiedział stworzenie wielkiej piłkarskiej potęgi nad Morzem Kaspijskim.</p>

<figure class="img">
  <img style="max-width:300px;height:400px; object-fit:cover" src="source/--4/img/anzy2.jpg" alt="">
  <figcaption>Sulejman Kerimow odmienił losy klubu<span>Hlebushek CC BY_SA 4.0</span></figcaption>
</figure>
...
<figure class="img">
  <img src="source/--4/img/anzy.jpg" alt="">
  <figcaption>Sulejman Kerimow znacząco wzmocnił skład drużyny<span>Соккер CC-BY_SA 3.0</span></figcaption>
</figure>
...
`,
`<p>Liczby występów w kadrze nie można wytłumaczyć umiejętnościami piłkarskimi, więc fenomen Podolskiego musi pochodzić z innych źródeł. Moment, w którym to Podolski stał się reprezentantem swojego kraju jest tutaj kluczowy. Lata 2004-2006, które w Niemczech zostały dość krytycznie odebrane — brak wyjścia z grupy na Mistrzostwach Europy 2004 (wtedy już Podolski znajdował się w drużynie) oraz zarzut braku jakiejkolwiek jakości w kadrze. </p>
<h3>Młodzieniec z potężną lewą nogą</h3>

<p>Nasz bohater wtedy był i to bez jakiejkolwiek ironii uznawany za jeden z największych snajperskich talentów na naszym kontynencie . W  rewolucji Klinsmanna, która zorientowana była głównie na młodych zawodnikach, Podolski dostał rolę jako kluczowy zawodnik odbudowy reprezentacji Niemiec. Patrząc z perspektywy marketingu — posunięcie trafne, uśmiechający się Podolski przyciągał masy kibiców na stadiony, jak i sponsorów. Zwłaszcza marka Adidas, uczyniła go „twarzą” Mistrzostw Świata 2006 w Niemczech. Od tego czasu „produkt” Podolski pod tym właśnie względem działa do dzisiaj bez zarzutów. Do dzisiaj naród niemiecki czeka, by Podolski (nawet w wieku 31 lat) „wybuchł” na boisku, bo w końcu jest naszym ulubieńcem...  Jednak teraz jest już niestety jedynie jednym z wielu.  Lukas Podolski jest więc doskonałym przykładem zawodnika, który od ponad 10 lat odbiega od marki „Podolski" umiejętnościami i nikomu to tak naprawdę nie przeszkadza. Innymi słowy, cała prawda nie leży na boisku, a poza nim. Wybór najlepiej zapowiadającego się zawodnika Mistrzostw Świata 2006 może się wydawać przepchnięty przez sponsorów. Wtedy jego bezpośrednimi konkurentami byli: Lionel Messi i Cristiano Ronaldo, patrząc czysto piłkarsko, to z perspektywy czasu aż trochę wstyd!
</p>
<figure class="img">
  <img style="max-width:400px" src="source/--4/img/Podolski3.jpg" alt="">
  <figcaption>Lukas Podolski w barwch FC Koeln<span>MKBN CC-SA-30</span></figcaption>
</figure>
<h3>Styl niezmieniony, nierozwinięty… </h3>

<p>Co ciekawe, w minionych czterech do sześciu lat, stale poszerzała się przepaść między sławą
a piłkarskimi umiejętnościami piłkarza. Specyficzną fascynację kibiców, konfrontującą blask fleszy z byciem piłkarzem, można określić jako kult Podolskiego. W Kolonii, Londynie, Milanie czy w Stambule, w żadnych z tych miejsc nie był pozyskiwany jako kluczowe wzmocnienie zespołu, a bardziej jako zawodnik uwielbiany przez kibiców. Jak już Podolski trafił do bramki, zazwyczaj swoją piekielnie mocną lewą nogą, to cały świat ma się cieszyć z nim. Ok, ale czy to wystarczy? Kiedyś dotrze to do kolegów z zespołu, kibiców i do trenerów i postawi się kreskę — koniec. </p>
<figure class="img">
  <img src="source/--4/img/Podolski4.jpg" alt="">
  <figcaption>Podolski na treningu Arsenalu<span>Wonker CC-SA-20</span></figcaption>
</figure>
<p>Lata 2004-2006, to okres, gdy Podolski był na topie. Wpada jednak w oko, że potem możemy zauważyć systematyczny regres, który częściowo wynika też z taktycznej rewolucji w piłce (np. innowacje Guardioli i Kloppa). Od 2006 roku piłkarski świat przeżywa czasy, gdzie taktyka nabrała innego znaczenia, zostały wprowadzone innowacyjne schematy, za którymi Podolski albo nie chciał, albo nie umiał nadążyć. </p>

<blockquote>
 „Jeszcze w latach 1996-2006 Podolski ze swoimi umiejętnościami byłby gwiazdą światowego formatu. Jednak teraz, 10 lat później, ujawnia się jego taktyczna stagnacja."
</blockquote>
<p>Jego styl gry w przeciągu tych wszystkich lat niezbyt się zmienił czy rozwinął. Trzeba jednak pochwalić, że polegał on głównie na tym co opanował do perfekcji. Balansem ciała potrafił stworzyć sobie 2-3 metry wolnego miejsca, by przełożyć piłkę na lewą nogę i oddać strzał, czy podać do kolegi z zespołu. Jeszcze w latach 1996-2006 Podolski ze swoimi umiejętnościami byłby gwiazdą światowego formatu. Jednak teraz, 10 lat później, ujawnia się jego taktyczna stagnacja. Trenerzy dają mu kredyt zaufania w formie wyjścia w podstawowej "11" w pierwszych 3-4 meczach. Potem zauważają, że swoja grą nic nie wnosi do drużyny. Zostaje wprowadzony jako rezerwowy- niezbędny do tworzenia atmosfery w szatni, ale mało przydatny na boisku. </p>
<p>Podobną sytuację możemy zauważyć w reprezentacji pod wodzą Joachima Löwa, na Mistrzostwach Świata w Brazylii, gdzie pełni bardziej rolę jako „zawodnik do spraw medialnych” (portale społecznościowe), oczywiście z takiej roli wywiązał się wzorowo. Na boisku natomiast spędził jedynie 53 minuty, w meczu z USA był w podstawowym składzie, lecz na boisku rozczarował
i w przerwie został zmieniony. </p>

<h3>Urodzony 10 lat za późno</h3>

<p>By na boisku istniał jako wielki zawodnik, jako gwiazda piłkarskiego świata, Podolski prawdopodobnie przyszedł na świat o 10 lat za późno. Z drugiej jednak strony mechanizmy marketingu, które od około 2004 roku dzięki Beckhamowi nabrały takiego rozpędu, że faktyczne umiejętności, albo ich brak mogły się skutecznie obronić. Z dynamiki, jaką nabrał marketing w piłce nożnej, Podolski jak nikt inny czerpał niebywałe korzyści.
Przyjdzie jednak kiedyś taki moment,  który zagrozi Podolskiemu,  a takim momentem były Mistrzostwa Europy 2016 we Francji. Oczywiście czynnik „atmosfera w drużynie” jest bardzo ważny podczas takich imprez i taki Podolski wywiązał się z tej roli jak nikt inny. Ale gdy na powołania czekają młodsi, zdolniejsi zawodnicy to rolę do „robienia” atmosfery w drużynie może objąć ktoś inny, ktoś, kto nie zabiera tak cennego miejsca w 23-osobowej kadrze. </p>

<p>Jako uczestnik Euro 2016 wydaje mi się, że Lukas Podolski ostatecznie został zdegradowany z roli kolegi z zespołu do jego maskotki. Nie liczy się to, co zrobisz na boisku, a bardziej to by „uczestniczyć” w imprezie, zadbać o idealną atmosferę, uśmiechać się na konferencjach prasowych, czy „twittować”. Gdy nadejdzie czas zakończenia kariery, Podolski pewnie zorganizuje wielki mecz, oczywiście z odpowiednią otoczką medialną i niech tak będzie, niech wszyscy zapamiętają Podolskiego jako dziecko piłkarskiego marketingu. </p>


<p style="text-align:center">****</p>

<p style="font-style: italic;">W czasie pisania tego artykułu Podolski wciąż czynnie uczestniczył w niemieckiej kadrze. Zawodnik zdecydował się już jednak zakończyć karierę reprezentacyjną i 22 marca 2017 roku  rozegrał ostatni mecz w niemieckich barwach. Widowisko nie stało na najwyższym poziomie, ale sam Podolski zdołał zapisać się na listę strzelców. Swoją bramkę zdobył, a jakby inaczej.... po uderzeniu z dystansu, mocnym strzałem lewą nogą. </p>

<figure class="img">
  <img style="max-width:400px" src="source/--4/img/Podolski2.jpg" alt="">
  <figcaption>Lukas Podolski<span>twitter.com/podolski10</span></figcaption>
</figure>

`).get()},

{ "page": "3", "title": "Boniek - good, Deyna - better, Sypniewski - the best", "content": new page("Boniek - good, Deyna - better, Sypniewski - the best","Tomasz Galas","Football","sypniewski.jpg", ["#Sport", "#Sypniewski"], "Własne",
...
`<p>Bałuty to podobno depresyjne i niebezpieczne miejsce. Niebezpieczne dla obcych, swoich się nie rusza. To właśnie tu, w wieku dziewięciu lat wypił pierwsze piwo Igor Sypniewski. "Pamiętam , że od dzieciństwa wszyscy, w tym ja, zamiast oranżady, pili piwo i palili papierosy. Obojętnie czy miałeś 7 lat czy 17". Tak jak jego rówieśnicy kibicował ŁKSowi, do którego stadionu nie miał daleko. Marzeniem każdego dzieciaka jest zagranie w ulubionej drużynie, Igorowi się to udało. Występował w ŁKSie, w którym to usłyszał zdanie, które zmieniło jego życie: "Nie pijesz, nie grasz. Pijesz, może zagrasz". Potem przeniósł się do miejscowego Orła, aby w 1995 trafić do Ceramiki Opoczno. W drugiej lidze trudno doszukiwać się talentów, jednak w tym obecnie dwudziestotysięcznym mieście taki talent się znajdował. Skąd włodarze greckiej Kavali dowiedzieli się o Sypku? Tak się akurat złożyło, że ten zespół trenował Grzegorz Lato. W "Arnogautach", u boku Leszka Pisza, talent Sypka eksplodował. Niestety miejsca w Kavali Igor długo nie zagrzał, bo pojawiła się oferta życia z Panathinaikosu. W "Koniczynkach" zagrał pięćdziesiąt razy w lidze, osiem razy pokonywał bramkarza rywali. Z początku był gwiazdą, ulubieńcem greckiej publiczności. Czczono go jak Zeusa to może za dużo powiedziane, ale Polak mógł poczuć się jak na Olimpie. Hat-tricka wpakował Vangelisowi Koentasowi z Apollonu Smyrnis (5-0, dwa trafienia dorzucił Warzycha). Ale ten mecz nie był jego najlepszym w zielonej koszulce z koniczyną na piersi. 21 listopada 2000 roku na magicznym Old Trafford, przeciwko wielkiemu Manchesterowi United, Igor zakładał siatki Beckhamowi i mijał jak chciał Gary'ego Neville'a. Warto dodać, że rano, tego samego dnia, Sypniewski obudził się na kacu i pił piwo z polskim pracownikiem hotelowym w Manchesterze. "Chłopak przyniósł piwa i został chwilę pogadać. Patrzył zafascynowany i pytał, jak to jest grać w Lidze Mistrzów, co czuję przed występem w Teatrze Marzeń". Otrzymał w odpowiedzi, że "ten cały Beckham, to nie jest wielki gracz". Po meczu Panathinaikos-Manchester przekonaliśmy się, kto miał rację, mimo, że "Czerwone Diabły" wygrały 3-1. W Lidze Mistrzów Sypniewski może poszczycić się też strzeleniem bramki Davidowi Seamanowi z Arsenalu. Już wtedy miał problemy z alkoholem.</p>
  ...
  `
  <div class="text">
    <h2><span class="romb"></span>To już koniec... :(</h2>
    <p><strong>...ale nie smuć się :) Teksty naszych autorów pojawiają się codziennie na <a href="http://sofasport.pl">sofasport.pl</a>. Możesz nas również obserwować na <a href="https://twitter.com/sofa_news?lang=pl">Twitterze</a> i <a href="https://www.facebook.com/SofaNews/">Facebooku</a> </strong></p>
    <p>Mamy nadzieję, że lektura naszego magazynu była dla Ciebie przyjemnością. Bylybiśmy wdzięczni za każdą formę promocji. Like czy udostępnienie nic nie kosztuje, a zwiększa zasięg naszego magazynu.</p>
